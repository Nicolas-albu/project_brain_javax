...
public class Login_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Legacy/PeqnDDA.gif"))); // NOI18N
    ...
    private void txtSenhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSenhaActionPerformed
        if(txtSenha.getText().equalsIgnoreCase("sdsa191292")){
            brain_main fp = new brain_main();
            fp.isVisible();
            dispose();
        }
